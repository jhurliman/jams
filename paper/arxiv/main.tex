...
estimator's one-frame bias). The other 28 have a global peak at a one-beat
multiple on strongly periodic drum or bass parts, exceeding the near-zero peak by
at most 21\%, or a correlation below 0.3 on dense sustained accompaniment; the
audit cannot exclude an offset for those 28 by this method, though none shows a
consistent shift. The audit script and report are in the repository. Slakh contains synthesized instrumental
