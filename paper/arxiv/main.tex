...
each group's onset-strength envelope with its MIDI onsets places the best lag
within 12--58\,ms after note-on for every class, consistent with instrument attack
times and the estimator's one-frame bias; no group shows an offset. The audit
script and report are in the repository. Slakh contains synthesized instrumental
