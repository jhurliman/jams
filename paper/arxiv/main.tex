...
interval in this paper from them (accompaniment rows, the bass reference, and the
separator table and deltas), refusing missing archives, duplicate rows, or
mismatched track sets. The tables and figure regenerate from a summary snapshot that records that
