...
the means and intervals above. Stored scores are thereby recomputed, not
reproduced: only the YourMT3+ reference-input predictions were archived for
rescoring from MIDI, and no inference was rerun.
