...
# commit ccc011abf7f89dd7922bb2888d48493b575c0289 (2026-06-09), models/bs_roformer/mel_band_roformer.py
# Author: Roman Solovyev (ZFTurbo) and contributors (upstream: lucidrains/BS-RoFormer, MIT).
# Unmodified except this header and the 'from models.bs_roformer.attend' import, made
# relative so the file works as part of this vendored package.
